...
public class DataTableElements extends Parent{
    ...
    @FindBy(xpath = "//td[text()='txt13']//following::div//ms-edit-button")
    public WebElement gradeleveledit;

    @FindBy(xpath = "//td[text()='txt13']//following::div//ms-delete-button")
